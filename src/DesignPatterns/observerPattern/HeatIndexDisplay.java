...
public class HeatIndexDisplay implements Observer{
	...
	public HeatIndexDisplay(WeatherStation2 weatherStation) {
		super();
	...
	public void update(Observable o, Object arg) {
		...
		if ((o instanceof WeatherStation2)) {
	...
	public void display() {
		System.out.println("Heat index is: " + computeHeatIndex(temperature, himudity));
	}
